...
A Silent Hill inspired Doom map for GZDoom 3.2.5.
Created in the span of almost a month for Joel's Doom Mapping Contest II.
...
Dynamic light shadowmaps, bloom and SSAO are recommended for the best visual
experience. Tone mapping is required for some effects to work correctly
("Uncharted 2" is the recommended option).
...
Credits for assets and stuff are inside the pk3. Everything should be fine in
...
2. The fire button can be held to charge melee weapons. Your character will
   grunt when the attack is fully charged.
